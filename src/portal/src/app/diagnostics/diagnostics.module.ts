...
@NgModule({
  ...
  declarations: [DiagnosticsComponent, ResultListComponent, ResultDetailComponent, PingPongReportComponent, DiagEventsComponent, TaskDetailComponent, PingPongOverviewResultComponent, TaskTableComponent, ResultLayoutComponent, RingReportComponent, RingOverviewResultComponent],
  entryComponents: [RingReportComponent, RingOverviewResultComponent, PingPongReportComponent, DiagEventsComponent, TaskDetailComponent]
})
